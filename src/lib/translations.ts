  ...
  en: {
    ...
    pages: {
      ...
      uxEvolve: {
        ...
        separatorsText: "Motion loops open each talk and set the pace of the summit. The same backgrounds carry over into the slides, so the deck and the transitions read as one piece.",
      ...
      descomplica: {
        ...
        desc2:      "As Design Manager from 2019 to 2024, I led design across brand and product: product design, the strategy and execution of landing pages, and the creation and organization of the design teams. The mandate was evolution, raising the bar on brand perception and on the quality of the creative visual output.",
        ...
        brand2:     "From that research I created and led the company's first branding refresh: a new positioning and a new set of values, translated into a visual world that is bold, diverse and unapologetically young. The goal was a clear step up in how the brand is perceived, from a course provider to a brand students want to be part of.",
        ...
        campaign2:  "That same language had to convert. I owned the strategy and execution of the landing pages, the point where brand meets acquisition: structure, messaging hierarchy, visual system and iteration cycles built around what actually moved enrollment.",
      ...
      estapar: {
        ...
        role1: "As Head of Design I led the redesign of the company's portal end to end: information architecture, visual language and the design of every page, from the navigation to the article templates.",
        nav1:  "The first problem was structure. Estapar's portfolio ranges from parking and monthly plans to reservations, the Zul+ app and electric charging, and each service spoke to a different audience through the same front door.",
        nav2:  "The navigation was rebuilt around who is visiting: companies, cities, drivers and brands. Each audience finds its own path to the services, with search as a shortcut for anyone who already knows what they came for.",
        visual1: "The visual update moves the brand away from the look of a parking operator. Large, confident typography, photography of real people on the move and the product shown in hand, at the size and rhythm of a phone screen.",
        visual2: "Zul+ gets the space of a product of its own inside the portal: a dedicated landing page, feature by feature, built to take the visitor from curiosity to download.",
        brand1: "Underneath it all is a repositioning: from a company that runs parking lots to a company that moves the city. The portal carries that shift, with content, news and services that speak of mobility rather than parking spaces.",
        brand2: "Articles, updates and newsletter live in the same system as the services, so the portal keeps working as a channel between releases, not only as a catalog.",
      },
    },
  ...
  pt: {
    ...
    pages: {
      ...
      uxEvolve: {
        ...
        separatorsLabel: "Separadores",
        separatorsText: "Loops de motion abrem cada talk e dão o ritmo do encontro. Os mesmos fundos seguem para os slides, para que o deck e as transições se leiam como uma peça só.",
      ...
      descomplica: {
        ...
        desc2:      "Como Design Manager de 2019 a 2024, liderei o design entre marca e produto: design de produto, estratégia e execução de landing pages, e a criação e organização dos times de design. O mandato era evolução, elevando a barra da percepção de marca e do nível de qualidade do output criativo visual.",
        ...
        brand2:     "A partir dessa pesquisa, criei e liderei o primeiro rebranding da empresa: um novo posicionamento e um novo conjunto de valores, traduzidos em um universo visual ousado, diverso e assumidamente jovem. O objetivo era um salto claro na forma como a marca é percebida, de provedora de cursos para uma marca da qual os estudantes querem fazer parte.",
      ...
      estapar: {
        ...
        role1: "Como Head of Design, liderei o redesign do portal da empresa de ponta a ponta: arquitetura de informação, linguagem visual e o desenho de cada página, da navegação aos templates de artigo.",
        nav1:  "O primeiro problema era estrutura. O portfólio da Estapar vai de estacionamentos e mensalistas a reservas, o app Zul+ e recarga elétrica, e cada serviço falava com um público diferente pela mesma porta de entrada.",
        nav2:  "A navegação foi reconstruída em torno de quem visita: empresas, cidades, quem dirige e marcas. Cada público encontra seu próprio caminho até os serviços, com a busca como atalho para quem já sabe o que veio fazer.",
        visual1: "A atualização visual afasta a marca da cara de operadora de estacionamento. Tipografia grande e confiante, fotografia de pessoas reais em movimento e o produto mostrado na mão, no tamanho e no ritmo da tela do celular.",
        visual2: "O Zul+ ganha o espaço de um produto próprio dentro do portal: uma landing page dedicada, funcionalidade por funcionalidade, construída para levar o visitante da curiosidade ao download.",
        brand1: "Por baixo de tudo há um reposicionamento: de uma empresa que opera estacionamentos para uma empresa que move a cidade. O portal carrega essa virada, com conteúdo, notícias e serviços que falam de mobilidade, não de vagas.",
        brand2: "Artigos, novidades e newsletter vivem no mesmo sistema que os serviços, para que o portal continue funcionando como canal entre lançamentos, não só como catálogo.",
      },
    },
    copyright: "© Pedro Julien 2026",
  },
